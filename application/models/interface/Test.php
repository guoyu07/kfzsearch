 ...
 * 测试 客户端接口类
 */
class Interface_TestModel extends kfz_system_SimpleRpcClient
{
    ...
    {
        $serverUrl             = Yaf\Registry::get('g_config')->site->kfzsearch . 'interface/Product/service';
        parent::__construct($serverUrl, 30);
    }

    public function testProductSearch($bizFlag, $realIp, $agent, $requestParams, $action, $isFormatData, $isFuzzySearch, $isBuildSnippets, $otherParams)
    {
        $parameters = array();
        ...
        return $result['result']['result']['itemList'];
    }
